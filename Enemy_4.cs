...
public class Enemy_4 : Enemy
{
    ...
    bool Destroyed (Part prt)
    {
        if(prt == null)
        {
            ...
            return (true);
            //Return trie (meaning yes, it was destroyed
        }
    ...
    void OnCollisionEnter(Collision coll)
    {
        ...
        switch(other.tag)
        {
            ...
            if (!bndCheck.isOnScreen)
                ...
                //Check whehter this part is still protected
                ...
                //Show the damage on the part
                ShowLocalizedDamage(prtHit.mat);
                if(prtHit.health <= 0)
                {
                    //Instead of destroying this enemy
